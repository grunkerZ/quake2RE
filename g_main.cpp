...
cvar_t* g_sanity_max;
cvar_t* g_sanity_drain_rate;
cvar_t* g_sanity_scream_threshold;
cvar_t* g_sanity_scream_freq;
...
void InitGame()
{
	...
	g_sanity_max = gi.cvar("g_sanity_max", "100", CVAR_ARCHIVE);
	g_sanity_drain_rate = gi.cvar("g_sanity_drain_rate", "2", CVAR_ARCHIVE);
	g_sanity_scream_threshold = gi.cvar("g_sanity_scream_threshold", "20", CVAR_ARCHIVE);
	g_sanity_scream_freq = gi.cvar("g_sanity_scream_freq", "15", CVAR_ARCHIVE);
