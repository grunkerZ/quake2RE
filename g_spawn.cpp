...
void SP_misc_hideable(edict_t* self);
//MOD END
...
static const std::initializer_list<spawn_t> spawns = {
	...
	//MOD START
	{ "trigger_darkspot",SP_trigger_darkspot},
	{ "trigger_fake_exit",SP_trigger_fake_exit},
	{ "trigger_loop", SP_trigger_loop},
	{ "info_loop_dest",SP_info_loop_dest},
	{ "monster_watcher", SP_monster_watcher},
	{ "monster_wireframe", SP_monster_wireframe},
	...
	{ "misc_hideable", SP_misc_hideable},
	//MOD END
